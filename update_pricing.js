...
const filePath = 'app/api/endpoints/pricing.py';
let content = fs.readFileSync(filePath, 'utf-8');

const replacement = `        p_cost = data.get('product_cost')
...
const originalBlock = `        p_cost = data.get('product_cost', {})
        t_profile = data.get('tax_profile', {})
        m_place = data.get('marketplace', {})
...
if (content.includes(originalBlock)) {
    ...
    if (!content.includes('"is_mocked": is_mocked')) {
    ...
    console.log("Backend endpoint modified.");
} else {
